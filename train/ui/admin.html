...
<body>
        ...
        <div class="collapse navbar-collapse d-flex justify-content-between">
            <div class="mx-auto"> <!-- Centering the links -->
                <ul class="navbar-nav" id="navl">
                    ...
                    <li class="nav-item">
                        <a id="registertrain-nav" class="nav-link" href="">Register Train</a>
                    </li>
                    <li class="nav-item">
                        <a id="profile-nav" class="nav-link" href="">Profile</a>
                    </li>
                   
                </ul>
            </div>
            <div>
                <a id="logout" class="btn btn-outline-light" href="adminlogin.html">Logout</a>
            </div>
        </div>
    </nav>
    ...
    <div class="container">
        ...
        <div id="registertrain-section" class="tab-content" style="display:none;">
